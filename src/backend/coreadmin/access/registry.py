...
from lims.access_registry import CLASSES as LIMS_CLASSES, MODULES as LIMS_MODULES, ACTIONS as LIMS_ACTIONS
for resource, cls in LIMS_CLASSES.items():
    ...
    for suffix, name in LIMS_ACTIONS[resource].items():
