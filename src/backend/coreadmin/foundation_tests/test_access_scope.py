...
class ScopePolicyTests(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.actor = Users.objects.create(username='actor', dept=cls.a, pwd_change_count=1)
        cls.other = Users.objects.create(username='other', pwd_change_count=1)
        cls.own = Users.objects.create(username='own', creator=cls.actor, dept_belong_id=cls.b.id, pwd_change_count=1)
        cls.same = Users.objects.create(username='same', creator=cls.other, dept_belong_id=cls.a.id, pwd_change_count=1)
        cls.sub = Users.objects.create(username='sub', creator=cls.other, dept_belong_id=cls.child.id, pwd_change_count=1)
        cls.remote = Users.objects.create(username='remote', creator=cls.other, dept_belong_id=cls.b.id, pwd_change_count=1)
        cls.protected = Users.objects.create(username='protected', is_superuser=True, pwd_change_count=1)
