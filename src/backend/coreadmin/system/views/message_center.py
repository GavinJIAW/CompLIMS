...
from coreadmin.system.models import MessageCenter, Users, MessageCenterTargetUser
from coreadmin.utils.json_response import SuccessResponse, DetailResponse
...
class MessageCenterSerializer(CustomModelSerializer):
    ...
    def get_user_info(self, instance, parsed_query):
        ...
        # You can do what ever you want in here
        # `parsed_query` param is passed to BookSerializer to allow further querying
        from coreadmin.system.views.user import UserSerializer
