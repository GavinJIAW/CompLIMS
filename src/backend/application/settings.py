...
Generated by 'django-coreadmin startproject' using Django 3.2.3.
...
MIDDLEWARE = [
    "coreadmin.utils.middleware.HealthCheckMiddleware",
    ...
    "coreadmin.utils.middleware.ApiLoggingMiddleware",
]
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_FILTER_BACKENDS": (
        ...
        "coreadmin.utils.filters.CustomDjangoFilterBackend",
        "rest_framework.filters.SearchFilter",
        "rest_framework.filters.OrderingFilter",
    ),
    "DEFAULT_PAGINATION_CLASS": "coreadmin.utils.pagination.CustomPagination",  # 自定义分页
    "DEFAULT_AUTHENTICATION_CLASSES": (
        "coreadmin.utils.authentication.SessionJWTAuthentication",
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_PERMISSION_CLASSES": [
        "rest_framework.permissions.IsAuthenticated",  # 只有经过身份认证确定用户身份才能访问
    ],
    "EXCEPTION_HANDLER": "coreadmin.utils.exception.CustomExceptionHandler",  # 自定义的异常处理
}
# ================================================= #
# ******************** 登录方式配置 ******************** #
# ================================================= #

AUTHENTICATION_BACKENDS = ["coreadmin.utils.backends.CustomBackend"]
# ================================================= #
# ****************** simplejwt配置 ***************** #
# ================================================= #
SIMPLE_JWT = {
...
SWAGGER_SETTINGS = {
    ...
    "DEFAULT_AUTO_SCHEMA_CLASS": "coreadmin.utils.swagger.CustomSwaggerAutoSchema",
}
