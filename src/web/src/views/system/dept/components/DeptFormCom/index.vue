<template>
	<el-form ref="formRef" :rules="rules" :model="deptFormData" label-width="100px" label-position="right" class="dept-form-com">
		<el-form-item label="父级组织" prop="parent">
			<el-tree-select
		...
		<el-form-item required label="组织标识" prop="key">
...
const rules = reactive<FormRules>({
	name: [{ required: true, message: '组织名称必填', trigger: 'blur' }],
	key: [{ required: true, message: '组织标识必填', trigger: 'blur' }],
});
