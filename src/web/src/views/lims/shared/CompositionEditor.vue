...
const props = defineProps<{ modelValue?: any[]; kind: string; permissions?: any; disabled?: boolean }>();
...
function selected(row: any, obj: any) { if (!obj) return; row.unit = obj.unit; row.target_name = obj.name; row.unit_cost = props.kind === 'cost_package' ? obj.unit_cost : obj.current_cost; }
</script>
